...
import UserDetailsModal from "./_usermodals/dashboard-admin-userdetailmodal";
...
export default function ManageUsers({ initialUsers, token }) {
  ...
  // Determine view mode based on screen size - Mobile: cards, Desktop: table
  ...
  return (
    <div className="space-y-6">
      ...
      {/* User Count and Results - lower z-index */}
      ...
      <div className="relative z-0">
            ...
            {paginatedUsers.length > 0 ? (
                ...
                <div key={index} className="bg-white rounded-lg shadow-sm p-4">
                  ...
                  <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900">{academicLevelText[user.academic_level] || "Desconocido"}</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-500">Documento</p>
                      <p className="font-medium text-gray-900">{user.document_id}</p>
                    </div>
                  </div>
                </div>
              ))
              ...
              <div className="bg-white rounded-lg shadow-sm p-6 text-center">
                <div className="flex flex-col items-center justify-center">
                  ...
                  <p className="text-gray-400 text-sm">Intenta ajustar los filtros o términos de búsqueda</p>
                </div>
              </div>
            )}
          </div>
        ...
        {/* Delete Confirmation Modal - high z-index but below sidebar */}
        {confirmDelete.show && (
          <Form method="post" onSubmit={() => {
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-20 p-4">
              <div className="bg-white w-full max-w-sm p-4 rounded-md shadow-lg">
        ...
        {/* User Details Modal - high z-index but below sidebar */}
        {selectedUser && (
          <UserDetailsModal
            user={selectedUser}
