...
export default function Login() {
  ...
  return (
    ...
    >
      ...
      {/* Main container - Solo reducimos el max-width */}
      <div className="w-full max-w-3xl flex overflow-hidden rounded-xl shadow-2xl relative z-10">
        
        {/* Left column - Reducimos ligeramente el tamaño del texto */}
        <div className="hidden lg:block lg:w-1/2 bg-indigo-600 p-10 text-white">
          <div className="h-full flex flex-col justify-center">
            <h2 className="text-2xl font-bold mb-6">Bienvenido a nuestra plataforma de cursos</h2>
            <p className="text-base mb-8">Expande tus conocimientos con nuestros cursos especializados</p>
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <span>Acceso a cursos de calidad</span>
              </div>
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-3 text-blue-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
        ...
        {/* Right column - Mantenemos la mayoría del espaciado */}
        <div className="w-full lg:w-1/2 bg-white p-8">
          <div className="mb-8 text-center">
            {/* Platform logo - Reducimos ligeramente */}
            <div className="inline-flex justify-center items-center w-14 h-14 bg-indigo-600 rounded-full mb-4">
          ...
          <Form method="post" className="space-y-6" onSubmit={(e) => { handleSubmit(e); }}>
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <Link to="/recuperarcontraseña" className="text-sm text-indigo-600 hover:text-indigo-800 transition-colors">
